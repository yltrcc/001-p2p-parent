...
public class AdminController {
	...
	@Reference(interfaceClass = IAdminService.class, version = "1.0.0", check = false, timeout = 15000)
	...
	public String toUpdateAdminPwdPage() {
		return "jsp/updateAdminPwd";
	}
	@RequestMapping("/welcome01")
	public String toWelcomePage() {
		return "jsp/welcome01";
	}
